(*
  ...
  TODO: Generalize to arbitrary gas costs.
  This requires the function to be defined as part of locale expressions_with_gas.

  TODO: Extend constant folding to function parameters.
*)
      ...
      proof (cases a)
        ...
        proof (cases a)
          ...
          proof (cases b)
            case v1: (Value t)
            then show ?thesis
            proof (cases "less t (TUInt b256) v (ShowL\<^sub>n\<^sub>a\<^sub>t al)")
              case None
        ...
        proof (cases a)
          ...
          proof (cases a)
            ...
            proof (cases b)
              case v1: (Value t)
              then show ?thesis
              proof (cases "less t (TUInt b256) v (ShowL\<^sub>i\<^sub>n\<^sub>t al)")
                case None
...
next
  ...
  proof (cases "g > 0")
    ...
    next
      ...
      also have "createSInt b v = createSInt b ?m_def" using bits.to_nat[of b] `\<not> v \<ge> 0` unfolding createSInt_def by auto
